        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6">
          ...
          <motion.div
            ...
            <div className="text-center mb-4">
              <h2 className="text-xl font-semibold text-white mb-2">What is Salvaging?</h2>
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-4 text-center">Salvage Sections</h2>
          ...
          <motion.div
            ...
            <h2 className="text-xl font-bold text-white mb-4 text-center">Pro Tips</h2>
