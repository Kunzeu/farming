    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Cargando precios desde GW2 API...</p>
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900 bg-white font-medium"
              min="1"
              max="10000"
            />
          </div>
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-md border">
          <p className="text-sm text-gray-600">
            <strong>Kit usado:</strong> Runecrafter&apos;s Salvage-o-Matic (30 cobre por uso)
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          ...
          <p className="text-2xl font-bold text-blue-900">{formatCurrency(totalMaterialsValue)}</p>
        </div>
        ...
        <div className="bg-red-50 rounded-lg p-4 border border-red-200">
          ...
          {unidentifiedGearPrice ? (
            <>
              <p className="text-2xl font-bold text-red-900">{formatCurrency(totalCost)}</p>
              <p className="text-xs text-red-600 mt-1">
                {formatCurrency(unidentifiedGearPrice || 0)} cada uno (TP)
              </p>
            </>
          ) : (
            <p className="text-lg text-red-700">Cargando precio...</p>
          )}
        </div>
        ...
        <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
          ...
          <p className="text-2xl font-bold text-orange-900">{formatCurrency(totalKitCost)}</p>
        </div>
        
        <div className={`rounded-lg p-4 border ${totalProfit >= 0 ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
          <div className={`flex items-center gap-2 mb-2 ${totalProfit >= 0 ? 'text-green-700' : 'text-red-700'}`}>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
                    <strong>Nota:</strong> Los precios se obtienen en tiempo real desde la <a href="https://api.guildwars2.com/v2/commerce/prices" target="_blank" className="text-blue-600 hover:text-blue-800 underline">API de GW2</a>. 
          ...
          Los drop rates están basados en datos oficiales de la <a href="https://wiki.guildwars2.com/wiki/Piece_of_Unidentified_Gear/Salvage_Rate" target="_blank" className="text-blue-600 hover:text-blue-800 underline">GW2 Wiki</a>{' '}
