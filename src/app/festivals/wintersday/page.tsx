    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-sky-900 to-cyan-900">
      ...
      <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Wintersday</h1>
          <p className="text-base sm:text-xl text-gray-300">Calculators and analysis for Wintersday</p>
        </motion.div>
