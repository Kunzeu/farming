        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          >
            <div className="flex items-center gap-2 justify-center mb-3">
              ...
              <h3 className="text-white font-semibold text-base">{t('footer.supportSite', 'Apoyo')}</h3>
            </div>
            ...
            <motion.a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-500 rounded-lg text-white font-medium text-sm hover:shadow-lg transition-all duration-300"
            ...
            >
              ...
              {t('footer.becomePatron', 'Hazte Patrocinador')}
            </motion.a>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 justify-center mb-3">
              ...
              <h3 className="text-white font-semibold text-base">{t('footer.communityContact', 'Comunidad')}</h3>
            </div>
            <div className="space-y-2">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-300 hover:text-white transition-all duration-300 group justify-center"
                whileHover={{ x: 5 }}
              >
                <DiscordIcon className="w-4 h-4 text-purple-400 group-hover:scale-110 transition-transform" />
              ...
              >
                ...
                <span className="font-medium text-sm">Bot (Qaliz)</span>
                <ExternalLink className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.a>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 justify-center mb-3">
              ...
              <h3 className="text-white font-semibold text-base">{t('footer.legal', 'Legal')}</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-2 justify-center mb-3">
              ...
              <h3 className="text-white font-semibold text-base">{t('footer.language', 'Idioma')}</h3>
            </div>
